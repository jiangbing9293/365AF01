 ...
 *@data: 2014-3-5
 */
public class CamRecordActivity extends BaseActivity implements IRegisterIOTCListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		mTitle.setTitle(getString(R.string.camrecord_activty_title));
		...
		mTitle.setRightButtonBg(R.drawable.icon_search, new OnRightButtonClickListener() {
			...
			public void onClick(View button) {
				...
				search.setClass(CamRecordActivity.this, RecordTimeActivity.class);
		...
		recordlist = (ListView)findViewById(R.id.camrecord_list);
		...
		recordlist.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
				...
				{
					Toast.makeText(CamRecordActivity.this, "Play Fail", Toast.LENGTH_SHORT).show();
					return;
				}
				...
				playback.setClass(CamRecordActivity.this, PlaybackActivity.class);
	...
	public class MyAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			holder.record_type.setText(UIApplication.getEventType(CamRecordActivity.this, evt.EventType, false));
			...
			case AVIOCTRLDEFs.IOTYPE_USER_IPCAM_LISTEVENT_RESP:
				...
				if (data.length >= 12 && mIsSearchingEvent) {
					...
					if (end == 1) {
						...
						if (list.size() == 0)
							Toast.makeText(CamRecordActivity.this, CamRecordActivity.this.getText(R.string.tips_search_event_no_result), Toast.LENGTH_SHORT).show();
					}
				}
