package freelancer.worldvideo.view;
...
public class TitleView extends FrameLayout implements View.OnClickListener {
	...
	public void setRightButtonNoBg(String text, OnRightButtonClickListener listener) {
		mRightBtn.setTextColor(Color.WHITE);
		mRightBtn.setText(text);
		mRightBtn.setVisibility(View.VISIBLE);
		mOnRightButtonClickListener = listener;
		mRightBtn.setCompoundDrawablesWithIntrinsicBounds(null, null, null,null);
	}
	public void setRightButtonBg(int res, OnRightButtonClickListener listener) {
		mRightBtn.setText("");
		mRightBtn.setCompoundDrawablesWithIntrinsicBounds(null, null,getResources().getDrawable(res),null);
		mRightBtn.setVisibility(View.VISIBLE);
		mOnRightButtonClickListener = listener;
	}
	public void setRightButtonBg(int res) {
		mRightBtn.setCompoundDrawablesWithIntrinsicBounds(null, null, getResources().getDrawable(res),null);
		mRightBtn.setVisibility(View.VISIBLE);
	}
