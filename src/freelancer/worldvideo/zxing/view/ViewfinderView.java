...
package freelancer.worldvideo.zxing.view;
...
public final class ViewfinderView extends View {
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			//canvas.drawText(getResources().getString(R.string.scan_text1), frame.left, (float) (frame.top - 2*(float)TEXT_PADDING_TOP *density), paint);
			//canvas.drawText(getResources().getString(R.string.scan_text2), frame.left, (float) (frame.top - (float)TEXT_PADDING_TOP *density), paint);
