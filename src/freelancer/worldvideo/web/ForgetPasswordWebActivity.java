 ...
 * @data: 2014-3-12
 */
public class ForgetPasswordWebActivity extends BaseActivity {
	...
	private void initWeb() {
		...
		webView.loadUrl(WebConfig.FORGET_PASSWORD_WEB);
		if(dialog == null)
			dialog = new ProgressDialog(this);
		dialog.setTitle(getText(R.string.toast_loading_page));
		dialog.setMessage(getText(R.string.dialog_wait));
		dialog.show();
//		dialog = ProgressDialog.show(ForgetPasswordWebActivity.this,null,getText(R.string.toast_loading_page));  
		webView.setWebViewClient(new WebViewClient() {
			...
			public void onReceivedError(WebView view, int errorCode,
				...
				Toast.makeText(ForgetPasswordWebActivity.this, getText(R.string.toast_phone_error) + description,
	...
	private void initTitle() {
		...
		mTitle.setTitle(getText(R.string.forgetpassword_activty_title).toString());
