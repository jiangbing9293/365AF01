 ...
 *@data: 2014-2-6
 */
public class FragmentIndicatorVideoPalyback extends LinearLayout implements OnClickListener 
{
...
//	private static final String TAG_TEXT_2 = "text_tag_2";
	...
	private FragmentIndicatorVideoPalyback(Context context) {
		super(context);
	}

	public FragmentIndicatorVideoPalyback(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void init() {
		...
		mIndicators[0] = createIndicator(R.string.video_palyback_local, COLOR_SELECT, TAG_TEXT_0);
		mIndicators[0].setBackgroundResource(R.drawable.tab_focus);
		mIndicators[0].setTag(Integer.valueOf(0));
		mIndicators[0].setOnClickListener(this);
		addView(mIndicators[0]);
		mIndicators[1] = createIndicator(R.string.video_palyback_cam, COLOR_SELECT, TAG_TEXT_1);
		mIndicators[1].setBackgroundResource(R.drawable.tab);
		mIndicators[1].setTag(Integer.valueOf(1));
		mIndicators[1].setOnClickListener(this);
		addView(mIndicators[1]);
//		mIndicators[2] = createIndicator(R.string.video_palyback_event, COLOR_SELECT, TAG_TEXT_2);
//		mIndicators[2].setBackgroundResource(R.drawable.tab);
